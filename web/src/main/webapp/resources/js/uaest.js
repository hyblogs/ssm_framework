...
if (typeof Piwik !== "object") {
    Piwik = (function () {
        var h, a = {}, q = document, d = navigator, E = screen, B = window,
            e = B.performance || B.mozPerformance || B.msPerformance || B.webkitPerformance, m = false, z = [],
            j = B.encodeURIComponent, A = B.decodeURIComponent, f = unescape, F, p, c;

        function v() {
        }

        v.generate = function () {
            var P = v._gri, Q = v._ha;
        ...
        v._ha = function (P, R) {
            var T = P.toString(16), Q = R - T.length, S = "0";
            for (; Q > 0; Q >>>= 1, S += S) {
                if (Q & 1) {
                    T = S + T
                }
        ...
        function i(P) {
            var R = new RegExp("^([a-z]+):"), Q = R.exec(P);
            return Q ? Q[1] : null
        }

        function b(P) {
            var R = new RegExp("^(?:(?:https?|ftp):)/*(?:[^@]+@)?([^:/#]+)"), Q = R.exec(P);
            return Q ? Q[1] : P
        }
        ...
        function N(af) {
            var R = function (ak, W) {
                    ...
                    return ak
                }, U, ai, ah, Q = [], Z = 1732584193, X = 4023233417, V = 2562383102, T = 271733878, S = 3285377520, ae, ad,
                ac, ab, aa, aj, P, Y = [];
            af = o(af);
            P = af.length;
        ...
        function G(Q, V, S) {
            var U = B.name.split("###"), T = U[1], P = U[2], R = x(Q, V);
        ...
        function y(an, aO) {
            var V = H(q.domain, B.location.href, t()), a8 = u(V[0]), bn = V[1], aV = V[2], aT = "GET", T = an || "",
                ak = "", aQ = "", bd = aO || "", aF, av = q.title,
                ...
                aR = [a8], Y = [], aJ = [], am = [], aP = 500, Z, ao, aa, ac,
                az = ["pk_campaign", "piwik_campaign", "utm_campaign", "utm_source", "utm_medium"],
                au = ["pk_kwd", "piwik_kwd", "utm_term"], bl = "_pk_", af, bm, ad = false, bg, aB, aE, aj = 63072000000,
                al = 1800000, aG = 15768000000, aC = true, aq = 0, X = false, aK = {}, U = {}, bh = 200, a1 = {},
            ...
            function ai(bs) {
                ...
                var bq = new RegExp("(^|;)[ ]*" + bs + "=([^;]*)"), br = bq.exec(q.cookie);
                return br ? A(br[2]) : 0
            }
            ...
            function aw(bs, bQ, bR, bt) {
                var bO, br = new Date(), bA = Math.round(br.getTime() / 1000), bU, bP, bv, bG, bL, bz, bJ, bw, bN,
                    bu = 1024, bW, bD, bK = X, bB = a2("ses"), bC = a2("ref"), bX = a2("cvar"), bH = R(), bF = ai(bB),
                    bM = P(), bT = aF || bn, bx, bq;
                if (ad) {
                    Q()
                }
            ...
            function aI(bt, bu) {
                var bq = new Date(), bs = aw("pg=" + j(M(bt || av)), bu, "log");
                aA(bs, aP);
                if (Z && ao && !aW) {
                    aW = true;
                    O(q, "click", bc);
            ...
            function a9(bt, bq, bu) {
                var bs = ap(aJ, "download"), br = ap(am, "link"), bv = new RegExp("\\.(" + ax + ")([?&#]|$)", "i");
            ...
            function a0(bv) {
                ...
                if (s(bv.href)) {
                    var bw = bv.hostname || b(bv.href), bx = bw.toLowerCase(), bs = bv.href.replace(bw, bx),
